...
Module.register('MMM-PublicTransportDB', {
	...
	defaults: {
		...
		hidden: false,
		stationId: 8001279,
		ignoredStations: ['638288', '638290'],             // Which stations should be ignored? (comma-separated list of station IDs)
		ignoredDirections: ['Celle', 'Ehlershausen', 'Otze'],
	...
	getDom: function () {
		...
		if (this.config.showTableHeaders) {
			...
			if (this.config.showTableHeadersAsSymbols) {
				...
				lineIcon.className = 'fa fa-train';
			...
			if (this.config.showTableHeadersAsSymbols) {
				...
				directionIcon.className = 'fa fa-map-pin';
